...
namespace Code.CubeMarching.GeometryGraph.Editor.DataModel
{
    public class ColorNode:NodeModel,IGeometryNode
    {
        ...
        public void Resolve(GeometryGraphResolverContext context, GeometryStackData stackData)
        {
            ...
            var color32Property = context.GetOrCreateProperty(this.Guid,
                new GeometryGraphMathOperatorProperty(context, GeometryPropertyType.Color32, MathOperatorType.Float3ToColor32, colorFloat3Property,context.ZeroFloatProperty,"Convert Float3 to Color"));
