...
//
//                 distanceFieldResolver = new GeometryInstructionIterator(positions, Instructions, layer);
...
//             MortonCellLayer mortonLayer, NativeList<MortonCoordinate> childPositions)
//         {
//             childPositions.Clear();
//             for (int i = 0; i < previousPositions.Length; i++)
//             {
//                 for (uint childCellIndex = 0; childCellIndex < 8; childCellIndex++)
//                 {
//                     childPositions.Add(mortonLayer.GetChildCell(previousPositions[i],childCellIndex));
//                 }
//             }
//         }
//
