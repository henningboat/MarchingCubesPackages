...
1. Make an [Issue](https://github.com/henningboat/autonamegameobjects/issues/new)
...
```json
    {
        "dependencies": {
            "com.henningboat.autonamegameobjects": "https://github.com/YOUR_USER/autonamegameobjects.git"
        }
    }
```
...
for enforcement at talktohenning@gmail.com. All complaints will be reviewed and investigated promptly and fairly.
